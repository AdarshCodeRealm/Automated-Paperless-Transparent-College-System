...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-background bg-slate-900">
      ...
      <nav className="fixed top-0 z-50 w-full border-b bg-background/95 backdrop-blur bg-black supports-[backdrop-filter]:bg-background/60">
        <div className="flex h-14 items-center px-4">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <span className="font-semibold">KokonutUI</span>
          </div>
      ...
      {/* Sidebar */}
      <aside className={`fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r bg-background pt-14 transition-transform md:translate-x-0 ${
