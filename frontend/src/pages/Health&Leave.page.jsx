...
const healthAdvisories = [
	{
		...
		content:
			"There has been an increase in seasonal flu cases. Students are advised to maintain proper hygiene, get adequate rest, and stay hydrated.",
		date: "2025-05-19",
		severity: "medium",
	},
	{
		...
		content:
			"A COVID-19 booster vaccination clinic will be held on campus from May 25-27. All students are encouraged to get their boosters if eligible.",
		date: "2025-05-18",
		severity: "high",
	},
	{
		...
		content:
			"Next week is Mental Health Awareness Week. Various workshops and counseling sessions will be available for all students.",
		date: "2025-05-15",
		severity: "low",
	},
];
					...
					<TabsContent value="report" className="space-y-4">
						<Card className="shadow-lg">
							<CardHeader>
								...
								<CardDescription>
									Submit health issues or campus leave notifications
								</CardDescription>
							</CardHeader>
							<CardContent>
					...
					<TabsContent value="history">
						<Card className="shadow-lg">
							<CardHeader>
								...
								<CardDescription>
									View all your previous notifications
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
					...
					<TabsContent value="advisories">
						<Card className="shadow-lg">
							<CardHeader>
								...
								<CardDescription>
									Important health information from the university
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="space-y-4">
									{healthAdvisories.map((advisory) => (
										...
										>
											<div
												className={`px-4 py-3 font-medium flex justify-between items-center ${getSeverityColor(
													advisory.severity
												)}`}
											>
												...
												<div className="text-sm">{advisory.date}</div>
											</div>
...
StudentNotification.propTypes = {
	...
	documentProvided: PropTypes.bool,
	isSick: PropTypes.bool,
	leftCampus: PropTypes.bool,
